...
import com.nls.dao.UserRepository;
import com.nls.security.AuthoritiesConstants;
import com.nls.service.MailService;
import com.nls.service.UserService;
import com.nls.service.dto.UserDTO;
import com.nls.web.rest.vm.ManagedUserVM;
import com.nls.web.rest.utils.HeaderUtil;
import com.nls.web.rest.utils.PaginationUtil;
...
//            mailService.sendCreationEmail(newUser);
    ...
    /**
     * GET /users-filter : get all users.
     *
     * @param pageable the pagination information
     * @return the ResponseEntity with status 200 (OK) and with body all users
     ...
     * generated
     */
    @GetMapping("/users/filter/{search}")
    @Timed
    public ResponseEntity<List<UserDTO>> filterUsers(@PathVariable String search, @ApiParam Pageable pageable)
            throws URISyntaxException {
        final Page<UserDTO> page = userService.filterManagedUsers("%"+search+"%", pageable);
