...
//    AppService appService;
    ...
    @RequestMapping(value = "/idKotaAsal/idKotaTujuan/idPelayaran/tglBerlaku/{idKotaAsal}/{idKotaTujuan}/{idPelayaran}/{tglBerlaku}", method = RequestMethod.GET)
    @ResponseBody
    public Object cariComposite(@PathVariable("idKotaAsal") String idKotaAsal, @PathVariable("idKotaTujuan") String idKotaTujuan, @PathVariable("idPelayaran") String idPelayaran, @PathVariable("tglBerlaku") String tglBerlaku,
            Pageable pageable,
            HttpServletResponse response) {
        PageRequest pr = new PageRequest(pageable.getPageNumber(), pageable.getPageSize(),
                Sort.Direction.ASC, "tgl_berlaku");
        return daoJdbc.listPricelist(idKotaAsal, idKotaTujuan, idPelayaran, tglBerlaku, pr);
    }
