 ...
 */
@Repository
public class DooringDaoJdbc {

    @Autowired
    MapResultSet mr;

    private final org.slf4j.Logger logger = LoggerFactory.getLogger(DooringDaoJdbc.class);

    public Object listDooring(String idKotaAsal, String idKotaTujuan, String tglBerlaku, PageRequest page) {
        ...
        String query = "select * from fn_get_setting_dooring(" + idKotaTujuan + ", " + idKotaAsal + ", '" + tglBerlaku + "') as ("
                + "  id int,  \n"
                + "  tgl_berlaku date,  \n"
