(function () {
    ...
    angular.module('BlurAdmin')
            .factory('KetJatuhTempoService', KetJatuhTempoService);

    /** @ngInject */
    KetJatuhTempoService.inject = ['$http', '$resource'];

    function KetJatuhTempoService($http, $resource) {
        var url = 'api/master/ket-jatuh-tempo';
        return {
